...
// Optimized Comments Modal with better performance
    ...
    return (
        ...
        >
            ...
            >
                ...
                <Typography sx={{ fontSize: 13, color: '#6B7280', mb: 1 }}>Comments feature coming soon...</Typography>
                <Button variant="contained" sx={{ mt: 3, bgcolor: '#2563EB', fontWeight: 600, '&:hover': { bgcolor: '#1D4ED8' } }} onClick={onClose}>
                    Close
                </Button>
            </Box>
        </Box>
...
const Home = () => {
    ...
    // Memoized user data to prevent re-renders
    const currentUserData = useMemo(() => {
        if (!storedUser) return null;
        return {
            name: `${storedUser.firstName} ${storedUser.lastName}`,
            title: storedUser.role || 'User',
            location: storedUser.address || 'No location',
            coverImage: 'https://images.unsplash.com/photo-1519904981063-b0cf448d479e?w=800&h=300&fit=crop',
            profileImage: storedUser.profilePhoto || 'https://randomuser.me/api/portraits/lego/1.jpg',
            friendsCount: 0,
            postsCount: 0,
            rating: 0,
            totalReviews: 0,
    ...
    const handleCommentClick = useCallback((postId: number) => {
